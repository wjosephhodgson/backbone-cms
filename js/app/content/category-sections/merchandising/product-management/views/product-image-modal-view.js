...
define([
  ...
  var ProductImageModalView = Backbone.View.extend({
    ...
    cacheElem: function() {
      ...
      this.$tip1         = this.$el.find('#big-tooltip-1');
      this.$tip2         = this.$el.find('#big-tooltip-2');
      this.$tip3         = this.$el.find('#big-tooltip-3');
    },
    ...
    handleMode: function() {
      ...
      if (modeVal == 'Advanced') {
        ...
        this.$tip1.attr('title','This is the largest white background .jpg image which is displayed on the Product Detail Page when a shopper clicks on the product image.');
        this.$tip2.attr('title','This is the largest close up .jpg image which is displayed on the Product Detail Page when a shopper clicks on the product close up image.');
        this.$tip3.attr('title','This is the largest environmental background .jpg image which is displayed on the Product Detail Page when a shopper clicks on the product environmental image.');
      } else {
        this.$advanced.addClass('hidden');
        this.$dimensions.addClass('hidden');
        this.$tip1.attr('title','This is the white background .jpg image which is displayed on the Product Detail Page and throughout your site.');
        this.$tip2.attr('title','This is the close up .jpg image which is displayed on the Product Detail Page.');
        this.$tip3.attr('title','This is the environmental background .jpg image which is displayed on the Product Detail Page.');
      }
    },
    ...
    uploadImage: function(e){
      ...
      self.readFile(file, function(e){
        ...
        if(self.isValidImageExtension(filename)) {
          ...
          id = imgslot;
          if( id == 'A1' || id == 'B1' || id == 'C1' || id == 'D1' ){
            size=194;
          } else if ( id == 'A2' || id == 'B2' || id == 'C2' || id == 'D2' ){
            size=194;
          } else {
            size=100;
          }
          ...
          if( activeimg.find('.icon').is('*') ){
            ...
            activeimg.append('<img src="'+url+'" id="img_img'+imgslot+'" width="'+size+'" height="'+size+'">');
          } else {
    ...
    drawCanvas: function(url, id, img){
      ...
      if( id == 'A1' ){
        self.$canvas.width(800).height(1000);
      } else if ( id == 'B1' || id == 'C1' || id == 'D1'){
        self.$canvas.width(1000).height(1000);
      } else if ( id == 'A2' ){
        self.$canvas.width(368).height(460);
      } else if ( id == 'B2' || id == 'C2' || id == 'D2' ){
        self.$canvas.width(460).height(460);
      } else if ( id == 'A3' || id == 'B3' || id == 'C3' || id == 'D3' ){
        self.$canvas.width(60).height(60);
      } else if ( id == 'D4' ){
        self.$canvas.width(272).height(340);        
      } else {

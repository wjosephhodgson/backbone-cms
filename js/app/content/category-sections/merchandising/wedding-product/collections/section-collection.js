define([
...
], function(Backbone, WeddingProductPageHomeModel) {
  var WeddingProductCollection = Backbone.Collection.extend({
   
    model: WeddingProductPageHomeModel,
    ...
    sortTypes: {
      ...
      ascending: function(section) { return section.get('name'); },
  ...
  return WeddingProductCollection;
});
define([
  'backbone',
  './wedding-product-page-home-view',
  'global-events'
], function(
  Backbone,
  WeddingProductPageHomeView,
  GlobalEvents
) {
  var WeddingProductPageHomeView = Backbone.View.extend({
    ...
    initialize: function() {
      ...
      WeddingProductPageHomeView.parent = this;
      // EditSectionView.parent = this;
    },

    render: function() {
      // Initialize with home view (displays graph)
      this.replaceVisible(WeddingProductPageHomeView.render());
    ...
    showHome: function() {
      this.replaceVisible(WeddingProductPageHomeView);
    },

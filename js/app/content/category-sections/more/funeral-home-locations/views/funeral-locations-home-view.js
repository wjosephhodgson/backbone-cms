define([
	'backbone',
	'../templates/funeral-locations-home-tpl',
	'../models/pickup-model',
	...
	'global-events',
	'jqueryui'
], function(Backbone, FuneralLocationHomeTpl, PickupModel, LocationModel, LocationCollection, LocationView, GlobalEvents) {
	var FuneralLocationHomeView = Backbone.View.extend({
		tagName: 'form',

		id:'p-funeral-locations',

		template: FuneralLocationHomeTpl,
	...
	return new FuneralLocationHomeView;
});
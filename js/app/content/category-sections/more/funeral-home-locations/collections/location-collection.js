define([
...
], function(Backbone, FuneralLocationModel) {
	var FuneralLocationCollection = Backbone.Collection.extend({
		url: '/mock/user-funeral-homes.json',

		model: FuneralLocationModel,
	...
	return new FuneralLocationCollection;
});
define([
...
], function(Backbone, TopFiftyProductsModel) {
	var TopProductsCollection = Backbone.Collection.extend({
		url: '/mock/user-top-products-reporting.json',
		model: TopFiftyProductsModel,
	...
	return new TopProductsCollection;
});
        ...
        P = PickerInstance.prototype = {
            ...
            start: function() {
                ...
                P.$root = $( PickerConstructor._.node( 'div', createWrappedComponent(), CLASSES.picker ) ).
                    ...
                    // pgraffam: If there’s a click on an actionable element, carry out the actions.
                    on( 'click', '[data-pick], [data-nav], [data-clear], [data-close]', function(e) {
                        ...
                        // pgraffam: If the close button is pressed
